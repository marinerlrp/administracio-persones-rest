...
RUN chown 2000:2000 /home/tcuser/start.sh
...
CMD id;env; echo "Han de existir i tenir valor les variables: ENTORN,VERSIO,CONTEXT"; cd /home/tcuser; . /home/tcuser/server/$ENTORN/entorn.sh; /home/tcuser/server/tomcat/bin/catalina.sh run
#CMD /bin/bash
